...
port_income_panel <- read.xlsx('C:/Users/jbwav/Desktop/r_honors/panels/NAICS_port_income_panel.xlsx', 'collapsed') 

profits_panel <- read.xlsx('C:/Users/jbwav/Desktop/r_honors/panels/NAICS_profits_panel.xlsx', 'collapsed')

depreciation_panel <- read.xlsx('C:/Users/jbwav/Desktop/r_honors/panels/NAICS_depreciation_panel.xlsx', 'collapsed')
...
dim(depreciation_panel)
dim(port_income_panel)
