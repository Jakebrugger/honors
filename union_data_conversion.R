...
conversion_table_98_02 <- read.xlsx('C:/Users/jbwav/Desktop/r_honors/cic_naics.xlsx', '98-02')
conversion_table_03_11 <- read.xlsx('C:/Users/jbwav/Desktop/r_honors/cic_naics.xlsx', '03-11')
conversion_table_12_15 <- read.xlsx('C:/Users/jbwav/Desktop/r_honors/cic_naics.xlsx', '12-17')
...
density_panel_03_11 <- union_density_panel_builder_lists_only(union_stats_03_11 , conversion_table_03_11)

density_panel_12_15 <- union_density_panel_builder_lists_only(union_stats_12_15 , conversion_table_03_11)



coverage_panel_98_02 <- union_coverage_panel_builder_lists_only(union_stats_98_02, conversion_table_98_02)

coverage_panel_03_11 <- union_coverage_panel_builder_lists_only(union_stats_03_11 , conversion_table_03_11)

coverage_panel_12_15 <- union_coverage_panel_builder_lists_only(union_stats_12_15 , conversion_table_03_11)


#coverage_panel_98_02
#coverage_panel_03_11
#coverage_panel_12_15

new_panel2 <- merge(density_panel_98_02, density_panel_03_11, all = TRUE, sort = FALSE)
density_panel <- merge(new_panel2, density_panel_12_15, all = TRUE, sort = FALSE)
dim(density_panel)

new_panel1 <- merge(coverage_panel_98_02, coverage_panel_03_11, all = TRUE, sort = FALSE)
coverage_panel <- merge(new_panel1, coverage_panel_12_15, all = TRUE, sort = FALSE)
dim(coverage_panel)
